...
def send_owner_info(message):
    owner_message = "This Bot Has Been Developed By ᚛ @RTC_CHEATS ᚜"  
...
def send_welcome(message):
    ...
    if is_super_admin(user_id):
        welcome_message = (
            f"Welcome, Super Admin! Developed By ᚛ @RTC_CHEATS ᚜\n\n"
            f"Admin Commands:\n"
        ...
        balance = get_admin_balance(user_id)
        welcome_message = (
            f"Welcome, Admin! Developed By ᚛ @RTC_CHEATS ᚜\n\n"
